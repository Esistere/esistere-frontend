module.exports = {
  'Caregiver/Familiare Registration Test': function (browser) {
    browser
      ...
      .setValue('input[name=data_di_nascita_paziente]', '1966-03-15')
  ...
  'Paziente Name Fail Test': function (browser) {
    browser
      .url('http://localhost:3000/esistere-frontend#/registrazione')
      .waitForElementVisible('body', 1000)
  ...
  'Paziente Cognome Fail Test': function (browser) {
    browser
      .url('http://localhost:3000/esistere-frontend#/registrazione')
      .waitForElementVisible('body', 1000)
      ...
      .setValue(
        ...
        'Giacomo José Francisco de Paula '+
        'Juan Nepomuceno María de los Remedios Cipriano '+
        'de la Santísima Trinidad Martyr Patricio Clito Ruíz y Picasso'
      )
  ...
  'Paziente Codice Fiscale Fail Test': function (browser) {
    browser
      .url('http://localhost:3000/esistere-frontend#/registrazione')
      .waitForElementVisible('body', 1000)
  ...
  'Paziente Data di Nascita Fail Test': function (browser) {
    browser
      .url('http://localhost:3000/esistere-frontend#/registrazione')
      .waitForElementVisible('body', 1000)
