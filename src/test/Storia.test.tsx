    ...
    browser
      ...
      .setValue(
        ...
        'della nostra vita, mamma. Ricordo il giorno' +
          ...
          'ricordo ancora più prezioso. In quei momenti,'+
          ' già capivo che l\'amore e la gioia' +
          'familiare sono legami eterni.'
      )
      ...
      .setValue(
        ...
        'Il vostro primo cane, con' +
        'occhi curiosi, completa il quadro di felicità familiare.'
      )
